...
memory_debug:
	...
	${CC} -Wall -Werror -Wpedantic -D F_MEMORY_DEBUG -std=c99 -g -o ./bin/html_table_parser ./lib/main.o ./lib/libhtml_table_parser.a ./lib/libhashmap.a ./lib/libfnv1a_hash.a ./lib/libmemory_debug.a
